...
🚀 Features
    ...
    .Recommendation Engine: Uses Collaborative Filtering to suggest books like a user's choice.
...
🏃 How to Run
      1.Clone the repository: "𝙜𝙞𝙩 𝙘𝙡𝙤𝙣𝙚 𝙝𝙩𝙩𝙥𝙨://𝙜𝙞𝙩𝙝𝙪𝙗.𝙘𝙤𝙢/𝙍𝙤𝙣𝙮𝙃𝙖𝙨𝙞𝙗𝙪𝙡/𝘽𝙤𝙤𝙠𝙂𝙚𝙣𝙞𝙚.𝙜𝙞𝙩"
      2.Install dependencies: "𝙥𝙞𝙥 𝙞𝙣𝙨𝙩𝙖𝙡𝙡 -𝙧 𝙧𝙚𝙦𝙪𝙞𝙧𝙚𝙢𝙚𝙣𝙩𝙨.𝙩𝙭𝙩"
      3.Setup Database: Ensure your XAMPP/MySQL server is running and the database matches the URI in app.py.
      4.Launch the app: "𝙥𝙮𝙩𝙝𝙤𝙣 𝙖𝙥𝙥.𝙥𝙮"
